...
val LightColorScheme = lightColorScheme(
    primary = SkylinePrimary,
    onPrimary = SkylineOnPrimary,
    primaryContainer = SkylinePrimaryVariant,
    secondary = SkylineAccent,
...
// Material 3 Dark Color Scheme (optional, but good practice)
